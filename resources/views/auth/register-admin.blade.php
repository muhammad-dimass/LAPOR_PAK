    ...
    <section class="contact">
      <form method="POST" action="{{ route('register') }}" style="border-radius: 20px; padding:50px;">
        ...
        <div style="display:none;">
            ...
            <x-text-input id="nik" class="block mt-1 w-full" type="text" name="nik" :value="old('nik')" required autofocus autocomplete="nik" value="4044044044044040"/>
        ...
        <div style="display:none;">
            ...
            <x-text-input id="level" class="block mt-1 w-full form-control hide" type="text" name="level" value="admin" required autofocus autocomplete="level" />
